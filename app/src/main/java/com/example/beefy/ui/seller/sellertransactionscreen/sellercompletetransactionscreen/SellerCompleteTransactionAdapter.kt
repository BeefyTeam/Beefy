...
class SellerCompleteTransactionAdapter (private val items : ArrayList<String>, private val listener : (String) -> Unit) : RecyclerView.Adapter<SellerCompleteTransactionAdapter.ViewHolder>() {
